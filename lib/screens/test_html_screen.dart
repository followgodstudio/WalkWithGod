...
class TestHtmlScreen extends StatelessWidget {
  static const routeName = '/testhtml';
  TestHtmlScreen();
  String htmlData = """
<h1>Header 1</h1>
...
""";
  ...
  Widget build(BuildContext context) {
    String articleId = ModalRoute.of(context).settings.arguments as String;
    return new Scaffold(
      appBar: NavBar(title: articleId),
      body: SingleChildScrollView(
        child: Html(
          data: htmlData,
          //Optional parameters:
          style: {
            "h1": Style(color: Colors.red, fontSize: FontSize(50)),
            "html": Style(
